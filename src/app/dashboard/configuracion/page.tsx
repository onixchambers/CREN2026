  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 max-w-5xl mx-auto pb-12">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        {/* PERMISOS DEL SISTEMA Y ZONA HORARIA */}
          ...
          <div className="flex items-center justify-between gap-3 mb-2">
            <h3 className="text-[#1a5276] font-bold flex items-center gap-2">
              ...
              <button 
                onClick={handleSave} 
                disabled={isSaving} 
                className="bg-[#27ae60] hover:bg-[#219653] disabled:opacity-50 text-white px-4 py-1.5 rounded text-xs font-semibold flex items-center gap-1.5 transition-colors shadow-xs cursor-pointer"
              >
