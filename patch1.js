...
const target1 = const handlePacienteChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
...
const replacement1 = const handlePacienteChange = (e: React.ChangeEvent<HTMLInputElement>) => {
...
console.log("Asistencia patched");
